  ...
  const steps = [
    {
      ...
      title: "Consultation",
      description:
        "We start by understanding your specific accounting needs and objectives. Our team works closely with you to define the scope of work, including financial reporting, bookkeeping, and compliance requirements.",
    },
    {
      number: "02",
      title: "Tailored Recruitment",
      description:
        "Leveraging our extensive network, we meticulously source and screen qualified accountants who possess the skills and expertise required for your business. You’ll receive a shortlist of candidates tailored to your criteria.",
    },
    {
      number: "03",
      title: "Seamless Integration",
      description:
        "Once you select your ideal accountant, we facilitate a smooth onboarding process, ensuring they are fully integrated into your team and equipped to manage your financial operations effectively. Ongoing support is provided to ensure success.",
    },
  ];
